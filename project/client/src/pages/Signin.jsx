    ...
    <div className="page-shell flex min-h-screen items-center">
      <div className="page-container grid gap-8 lg:grid-cols-[1fr_1fr] lg:items-center">
        ...
        <section className="ink-panel px-8 py-12 md:px-12">
          ...
          <h1
            className="max-w-sm text-[42px] font-medium text-white leading-[1.08]"
            style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", letterSpacing: "-0.02em" }}
          >
            Return to your curated wardrobe workspace.
          </h1>
          <p className="mt-5 max-w-[340px] text-[14px] leading-[1.75]" style={{ color: "rgba(210,190,165,0.65)" }}>
            Access your dashboard, manage rental listings, track orders, and stay close to every booking update.
          </p>

          <hr className="warm-rule mt-10 mb-8" />

          <div className="space-y-3">
            {["Buy rare fashion pieces.", "Rent for any occasion.", "List your wardrobe."].map((t) => (
              <div key={t} className="flex items-center gap-3">
                <span
                  className="h-1.5 w-1.5 flex-shrink-0 rounded-full"
                  style={{ background: "rgba(200,164,106,0.7)" }}
                />
                <span className="text-[13.5px]" style={{ color: "rgba(200,175,150,0.65)" }}>{t}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* Right: form */}
        <form onSubmit={handleSubmit} className="auth-form-panel mx-auto w-full max-w-md">
          <h2
          ...
          <p className="mt-2 text-[13.5px]" style={{ color: "#6b5f56" }}>
            Sign in to continue using CircuTrade.
          </p>
          ...
          <p className="mt-5 text-center text-[13px]" style={{ color: "#6b5f56" }}>
            Don&apos;t have an account?{" "}
            <Link to="/signup" className="font-semibold text-stone-900 underline underline-offset-4">
              Sign Up
            </Link>
          </p>
        </form>
...
/* =====================================================
   pages/SignUp.jsx  — export separately in your project
   ===================================================== */
// import { useState } from "react";
// import { Link, useNavigate } from "react-router-dom";
// import API from "../api/axios";
      ...
      <div className="page-container grid gap-8 lg:grid-cols-[1fr_1fr] lg:items-center">
        ...
        <section className="accent-panel px-8 py-12 md:px-12">
          ...
          <p className="page-subtitle">
            Start buying, selling, and renting through a refined dashboard experience built for premium listings.
          </p>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {[
              ...
              <div
                ...
                style={{ background: "rgba(255,255,255,0.55)", border: "1px solid rgba(200,164,106,0.2)" }}
              >
                <p
                  className="text-[22px] font-medium"
                  style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", color: "var(--warm)" }}
                >
                  {n}
                </p>
                <p className="mt-1 text-[13px] font-medium text-stone-700">{t}</p>
              </div>
            ))}
          </div>
        </section>
